...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    CampaignItem: function CampaignItem() {
      return __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ../components/CampaignItem */ "./resources/js/components/CampaignItem.vue"));
    }
  },
  created: function created() {
    ...
    axios.get('api/blog/random/2').then(function (response) {
      var data = response.data.data;
      _this.blogs = data.blogs; // console.log(this.blogs)
    })["catch"](function (error) {
      var response = error.response; // console.log(response)
    });
  }
